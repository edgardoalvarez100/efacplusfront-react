...
const Inicio = () => {
    ...
    const people = `${Icons}#person-circle`;
    const toogle = `${Icons}#toggles2`;
                        ...
                        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                            <div className="feature col">
                                ...
                                <a href="/" className="icon-link d-inline-flex align-items-center">
                                    Call to action
                                    <svg className="bi" width="1em" height="1em"><use xlinkHref={chevron}></use></svg>
                                </a>
                            </div>
                            <div className="feature col">
                                <div className="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
                                    <svg className="bi" width="1em" height="1em"><use xlinkHref={people}></use></svg>
                                </div>
                            ...
                            <div className="feature col">
                                <div className="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
                                    <svg className="bi" width="1em" height="1em"><use xlinkHref={toogle}></use></svg>
                                </div>
                                <h2>Reportes</h2>
                                <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
                                <a href="/" className="icon-link d-inline-flex align-items-center">
